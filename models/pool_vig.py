...
class ViG(nn.Module):
    def __init__(self, n_class):
        ...
        self.vit = VViGBlock(96, 6, 512, (2, 2), 0.1)
        self.decode2 = Decoder(256 + 128, 128)
        self.decode1 = Decoder(128 + 128, 128)
        self.head = _FCNHead(128, n_class)
        self.apply(self.__init_weights)
        self.vis = False
        self.output_conv = nn.Conv2d(128, 3, kernel_size=1)
        self.proj = nn.Conv2d(128, 512, kernel_size=1)
...
if __name__ == "__main__":
    ...
    summary(model, (3, 257, 257), device='cpu')